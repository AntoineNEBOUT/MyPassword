...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout_7->addWidget(groupBox_4, 3, 1, 1, 1);
        ...
        gridLayout_7->addWidget(groupBox_3, 3, 0, 1, 1);
        ...
        gridLayout_7->addWidget(groupBox_6, 4, 1, 1, 1);

        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName("horizontalLayout");
        categoryImageLabel = new QLabel(centralwidget);
        categoryImageLabel->setObjectName("categoryImageLabel");
        categoryImageLabel->setScaledContents(true);
        categoryImageLabel->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        horizontalLayout->addWidget(categoryImageLabel);
        ...
        horizontalLayout->addWidget(categorieName);
        ...
        gridLayout_7->addWidget(categoriesNameComboBox, 1, 1, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        categoryImageLabel->setText(QString());
